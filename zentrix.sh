...
if [ ! -e "$ROOTFS_DIR/.installed" ]; then
  ...
  printf "\033c"
  echo "${YELLOW}Please choose an OS for your Zentrix VM                                              ${NC}"
  echo "                                                                                               "  
  echo "* [1] Debian                                                                                   "
  echo "* [2] Ubuntu                                                                                   "
  echo "* [3] Void Linux                                                                               "
...
# Download run.sh
curl -Ls "https://raw.githubusercontent.com/halexgg/scripts/main/run.sh" -o "$ROOTFS_DIR/home/container/run.sh"
